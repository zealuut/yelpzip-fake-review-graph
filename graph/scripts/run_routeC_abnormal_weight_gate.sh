...
OUTPUT_DIR="${OUTPUT_DIR:-${ROOT_DIR}/graph/outputs/routeC_abnormal_score_weight_gate_${TIMESTAMP}}"
LOG_DIR="${ROOT_DIR}/graph/logs"
LOG_FILE="${LOG_DIR}/routeC_abnormal_score_weight_gate_${TIMESTAMP}.log"
DETACH="${DETACH:-1}"
